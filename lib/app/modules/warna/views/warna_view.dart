...
import 'package:kataku/app/modules/warna/views/const_warna.dart';

import '../controllers/warna_controller.dart';

class WarnaView extends GetView<WarnaController> {
  const WarnaView({Key? key}) : super(key: key);
  @override
          ...
          Container(
            child: Column(
              children: [
                ...
                Expanded(
                  child: ImageButtonItemBuilder(WARNA, WARNAList),
                ),
              ],
            ),
          ),
